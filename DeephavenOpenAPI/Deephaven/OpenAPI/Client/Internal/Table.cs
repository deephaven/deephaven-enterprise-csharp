...
namespace Deephaven.OpenAPI.Client.Internal
{
    public class Table
    {
            ...
            Action<TableSnapshot> tableSnapshotHandler)
        {
            ...
            var columnDefinitions = _tableDefinition.Definition.Columns;
        ...
        private BitArray GetColumnsBitArray(params string[] columns)
        {
            ...
            BitArray columnsBitArray = new BitArray(_tableDefinition.Definition.Columns.Length);
            if (columns == null)
            {
            ...
            else
            {
                ...
                {
                    columnsBitArray.Set(i, columnSet.Contains(_tableDefinition.Definition.Columns[i].Name));
                }
            }
        ...
        {
            // create the columns bit set
            var columnsBitArray = new BitArray(_tableDefinition.Definition.Columns.Length);
            if (columns == null)
            {
                columnsBitArray.SetAll(true);
            }
            ...
            return new TableData(_tableDefinition.Definition.Columns, snapshot);
        }
