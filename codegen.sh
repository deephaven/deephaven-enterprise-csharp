...
dotnet ${SCRIPTPATH}/SharedGenerator/bin/$CONFIGURATION/netcoreapp2.0/DeephavenOpenAPI.SharedGenerator.dll  ${SCRIPTPATH}/rpc-schema WebApi,Worker ${SCRIPTPATH}/DeephavenOpenAPI/Generated
